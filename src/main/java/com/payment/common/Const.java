...
public class Const {
	...
	public static final String SESSION_ROLE_ID = "sessionRoleId";
	...
	public static final String ROLE_ID_ADMIN = "1"; //管理员-支付运营商
	public static final String ROLE_ID_SUB_MGR = "2"; //下级运营商
	public static final String ROLE_ID_SHOP= "3"; //商户
	public static final String ROLE_ID_CASHIER = "4"; //收银员
