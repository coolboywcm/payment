...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
			...
			<!-- 检索  -->
			<form action="report/busCollectList" method="post" name="qryForm" id="qryForm">
			...
			<table style="" class="qryTable">
								...
								<tr>
                            		...
                            		<td colspan="3">
										  ...
										  &nbsp;<button class="btn  btn-small" type="reset" onclick="$('#beginDate').val('');$('#endDate').val('');window.location.reload()">重置<i class="icon-undo icon-on-right"></i> </button>
					...
					<c:when test="${not empty list}">
						<c:forEach items="${list}" var="item" varStatus="vs">
							<tr>
								...
								<td><fmt:formatNumber type="number" value="${item.refundAmountTotal/100}" pattern="0.00" maxFractionDigits="2"/></td>
							</tr>
	...
	<!-- PAGE CONTENT ENDS HERE -->
		...
		//导出excel
		function toExcel(){
			window.location.href='<%=basePath%>report/excel?'+$("#qryForm").serialize();
		}
