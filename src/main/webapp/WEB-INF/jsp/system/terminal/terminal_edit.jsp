...
<form action="terminal/${action}" name="dataForm" id="dataForm" method="post">
		...
		<table style="margin-left: 10px;height: 180px;">
			...
			<tr>
			   <td style="text-align: right;padding-top: 10px;">终端编号：</td>
				<td style="padding-top: 10px;"><input type="text" name="code" id="code" value="${bean.code }" maxlength="32" placeholder="这里输入编号" title="编号" onblur="hasN('${bean.code }')"/></td>
			</tr>
