					...
					<div class="step-content row-fluid position-relative">
						...
						<div class="step-pane" id="step3">
							...
							<table style="margin-left: 20px;" class="formTable">
								...
								<tr>
								   <td style="text-align: right;padding-top: 20px;"><span>单笔最低优惠：</span></td>
									<td style="padding-top: 20px;">
									   <span class="input-icon">
										   <input type="text" dataType="dec"  name="dbzdyh" id="dbzdyh"  value="${active.dbzdyh }" style="width: 280px;"  placeholder="[每次最低优惠金额] 列如：9.9"  need>
										   <i class="icon-cash">￥</i>
									   </span>
									   <span class="red">*</span>
									</td>
								...
								<tr>
								   <td style="text-align: right;padding-top: 20px;"><span>单笔最高优惠：</span></td>
									<td style="padding-top: 20px;">
									   <span class="input-icon">
										   <input type="text" dataType="dec"  name="dbzgyh" id="dbzgyh" value="${active.dbzgyh}" style="width: 280px;"  placeholder="[每次最高优惠金额] 列如：9.9"  need>
										   <i class="icon-cash">￥</i>
									   </span>
									   <span class="red">*</span>
									</td>
								...
								<tr>
								   <td style="text-align: right;padding-top: 20px;"><span>单卡合计优惠限额：</span></td>
									<td style="padding-top: 20px;">
									   <span class="input-icon">
										   <input type="text" dataType="dec"  name="dkhjyhxe" id="dkhjyhxe" value="${active.dkhjyhxe}"  style="width: 280px;" placeholder="[每张卡合计最高优惠金额] 列如：10"  need>
										   <i class="icon-cash">￥</i>
									   </span>
									   <span class="red">*</span>
									 </td>
