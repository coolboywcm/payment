				...
				<div class="row-fluid">
					<div id="fuelux-wizard" class="row-fluid hidden">
					  <ul class="wizard-steps">
						...
						<li data-target="#step2"><span class="step">2</span> <span class="title">2.金额次数</span></li>
						<li data-target="#step3"><span class="step">3</span> <span class="title">3.周期设定</span></li>
						<c:if test="${action == 'addActive' }">
							<li data-target="#step4"><span class="step">4</span> <span class="title">4.卡选择</span></li>
						</c:if>
					  </ul>
					</div>
					...
					<div class="step-content row-fluid position-relative">
						...
						<div class="step-pane" id="step2">
							...
							<table style="margin-left: 20px;" class="formTable">
								<tr>
								   <td style="text-align: right;padding-top: 0px;"><span>优惠总次数：</span></td>
									<td style="padding-top: 0px;">
									  <input type="text" dataType="num" name="yhzcs" id="yhzcs" value="${active.yhzcs }" maxlength="32" placeholder="[可参与的活动数量] 列如：999999" title="优惠总次数" need/>
									  <span class="red">*</span></td>
								</tr>
								<tr>
								   <td style="text-align: right;padding-top: 30px;"><span>单日最多次数：</span></td>
									<td style="padding-top: 30px;"><input type="text" dataType="num"  name="drzdcs" id="drzdcs" value="${active.drzdcs }" maxlength="32" placeholder="[单日最多参与活动的次数] 列如：999999" title="单日最多次数"  need/><span class="red">*</span></td>
								</tr>
								<tr>
								   <td style="text-align: right;padding-top: 20px;"><span>活动原价：</span></td>
									<td style="padding-top: 20px;">
									   <span class="input-icon">
										   <input type="text" dataType="dec"  name="hdyj" id="hdyj" value="${active.hdyj }" style="width: 280px;" placeholder="[每次活动原金额] 列如：30" need>
										   <i class="icon-cash">￥</i>
									   </span>
									   <span class="red">*</span>
									 </td>
								...
								<tr>
								   <td style="text-align: right;padding-top: 20px;"><span>优惠单价：</span></td>
									<td style="padding-top: 20px;">
									   <span class="input-icon">
										   <input type="text" dataType="dec"  name="yhdj" id="yhdj" value="${active.yhdj }" style="width: 280px;"  placeholder="[每次活动金额] 列如：9.9" need>
										   <i class="icon-cash">￥</i>
									   </span>
									   <span class="red">*</span>
									</td>
								...
								<tr>
								   <td style="text-align: right;padding-top: 20px;"><span>单卡可参与次数：</span></td>
									<td style="padding-top: 20px;">
									   <input type="text"  dataType="num" name="dkkcycs" id="dkkcycs" value="${active.dkkcycs }" maxlength="32" placeholder="[单张卡片最多可参与次数] 列如：10" title="活动名称" need/><span class="red">*</span></td>
								</tr>
							</table>
